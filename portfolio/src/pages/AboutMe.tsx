...
function AboutMe() {
  ...
  return (
    <div className='flex flex-col h-auto w-screen overflow-y-hidden bg-bg'>
      ...
      {/* BACKGROUND */}
      {/* <div className='fixed w-full z-0 bg-bg'>
        <div className='absolute top-10 left-20 w-[350px] h-[350px] bg-accent rounded-full filter blur-[150px] opacity-30'></div>
        <div className='absolute bottom-20 right-40 w-[200px] h-[200px] bg-accent rounded-full filter blur-[100px] opacity-30'></div>
        <img src={Logo} alt='logo' className='opacity-[10%] w-[60%] absolute right-48 bottom-24'/>
      </div> */}
