...
function Background() {
  ...
  return (
    <div className='z-0 fixed h-screen w-screen bg-purple-400 bg-opacity-0 overscroll-none'>
      ...
      <div className='absolute bottom-20 right-48 phone:bottom-10 phone:right-0 phone:scale-75 bg-accent w-[150px] h-[150px] rounded-full blur-[80px] opacity-40'></div>
