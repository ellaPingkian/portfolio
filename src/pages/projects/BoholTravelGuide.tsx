      ...
      <div className="w-screen px-24 h-auto phone:px-5 tablet:px-10 font-secondary">
        ...
        <div className='flex flex-col pt-48 gap-4 phone:pt-24'>
          ...
          <div className='flex flex-col gap-2 px-32 tablet:px-0 phone:px-0'>
            <span className='font-secondary text-2xl text-[#747474] tracking-[0.07em] phone:text-sm '>A UI/UX Case Study:</span>
            <span className='font-secondary font-extrabold text-6xl phone:text-4xl text-[#24303C] tracking-[0.03em] phone:tracking-[0em]'>Elevating the Travel Experience: A Travel Guide Homepage Redesign</span>
          </div>
          ...
          <div className='flex flex-col pt-16'>
            ...
            <div className='flex flex-row phone:flex-col gap-2 align-middle justify-between py-8 px-32 tablet:px-0 phone:px-10 phone:gap-6'>
              <div className='flex flex-col gap-1'>
                ...
                <span className='font-secondary font-semibold text-[#24303C] tracking-[0.05em]'>August - September 2023</span>
              </div>
              <div className='flex flex-col gap-1'>
        ...
        <div className='flex flex-col w-full py-16 gap-32'>
          <span className='font-secondary font-semibold text-4xl text-[#24303C]'>User Research</span>
          ...
          {/* Main Results */}
          <div className='flex flex-col gap-16'>
            <span className='font-secondary font-semibold text-2xl text-[#24303C]'>Main Survey Results</span>
        ...
        <div className='flex flex-col gap-32 py-16'>
          ...
          <div className='flex flex-col gap-12'>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <div className='px-10 phone:px-3 phone:py-3 py-8 overflow-hidden bg-gray-300 bg-opacity-30 rounded-2xl'>
                <div className='flex flex-row gap-4 h-[100vh] phone:h-auto w-full items-start justify-between'>
                  ...
                  <div className='w-[25%] h-full flex flex-col gap-2'>
                    ...
                    <img src={lofi1} alt='lofi ver1' className='h-auto w-full rounded-2xl'/>
                  </div>
                  
                  <div className='w-[25%] h-full flex flex-col gap-2'>
                    <span className='text-xs opacity-70'>Version 1</span>
                    <img src={lofi2} alt='lofi ver1' className='h-auto w-full rounded-2xl'/>
                  </div>

                  <div className='w-[25%] h-full flex flex-col gap-2'>
                    <span className='text-xs opacity-70'>Version 1</span>
                    <img src={lofi3} alt='lofi ver1' className='h-auto w-full rounded-2xl'/>
                  </div>

                  <div className='w-[25%] h-full flex flex-col gap-2'>
                    <span className='text-xs opacity-70'>Version 1</span>
                    <img src={lofi4} alt='lofi ver1' className='h-auto w-full rounded-2xl'/>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='flex flex-col gap-12'>
            ...
            <div className='px-5 phone:px-3 phone:py-3 py-8 overflow-auto bg-gray-400 bg-opacity-30 rounded-2xl'>
        ...
        <div className='flex flex-col gap-12 py-16'>
          ...
          <img src={StyleGuide} alt='style guide' className='h-auto w-full shadow-xl rounded-2xl'/>
        </div>
        ...
        <div className='flex flex-col gap-8 pt-16 pb-48 px-48 tablet:px-0 phone:px-0'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <span className='text-[#393939] text-lg tracking-[0.03em] phone:text-sm'>I would continue to complete the whole project and create the remaining screens. I would also like to do an iteration after conducting the usability testing and would collaborate with the owner and administrator of the current website to discuss more about the project. </span>
          </div>
