      ...
      <div className="w-screen px-24 h-auto phone:px-5 tablet:px-10 font-secondary">
        ...
        <div className='flex flex-row tablet:flex-col phone:flex-col h-[80vh] tablet:h-auto phone:h-auto pt-12 tablet:gap-12 phone:gap-12'>
          <div className='flex flex-col justify-between w-[35%] tablet:w-full phone:w-full tablet:text-center phone:text-center'>
            <div className='flex flex-col justify-between gap-3 text-neutrals-dark-600'>
          ...
          <div className='flex items-center justify-end w-[65%] tablet:w-full phone:w-full tablet:justify-center phone:justify-center'>
            <img src={Nomo} alt='nomo thumbnail' className='h-[500px] w-auto tablet:h-[300px] phone:h-[250px]'/>
          </div>
        </div>
        ...
        <div className='flex flex-col pt-48 gap-4 phone:pt-24'>
          ...
          <div className='flex flex-col gap-2 px-32 tablet:px-0 phone:px-0'>
            <span className='font-secondary text-2xl text-neutrals-mid-400 tracking-[0.07em] phone:text-sm '>Crafting the Perfect Blend:</span>
            <span className='font-secondary font-extrabold text-6xl phone:text-4xl text-neutrals-dark-600 tracking-[0.03em] phone:tracking-[0em]'>Revitalizing the Coffee Space Brand with a Custom Web Design Solution</span>
          </div>
          ...
          <div className='flex flex-col pt-16'>
            ...
            <div className='flex flex-row phone:flex-col gap-2 align-middle justify-between py-8 px-32 tablet:px-0 phone:px-10 phone:gap-6'>
              ...
              <div className='flex flex-col gap-1'>
                <span className='font-secondary text-xs text-neutrals-mid-400 tracking-[0.07em]'>PLATFORM</span>
        ...
        <div className='flex flex-row tablet:flex-col phone:flex-col py-24 gap-14'>
          <div className='flex flex-col gap-4 w-[50%] tablet:w-full phone:w-full'>
            ...
            <span className='text-neutrals-mid-500 text-lg tracking-[0.03em] phone:text-sm'>
          ...
          <div className='flex-col flex gap-4 w-[50%] tablet:w-full phone:w-full'>
            ...
            <span className='text-neutrals-mid-500 text-2xl font-semibold italic'>The absence of an online presence.</span>
            <span className='text-neutrals-mid-500 text-lg tracking-[0.03em] phone:text-sm'>
        ...
        <div className='flex flex-row tablet:flex-col phone:flex-col py-24 gap-14'>
          ...
          <div className='flex-col flex gap-4 w-[50%] tablet:w-full phone:w-full'>
            ...
            <span className='text-neutrals-mid-500 text-2xl font-semibold italic'>Express and highlight the brand’s distinctive qualities from other present brands.</span>
            <span className='text-neutrals-mid-500 text-lg tracking-[0.03em] phone:text-sm'>
            ...
            <span className='text-neutrals-mid-500 text-2xl font-semibold italic pt-4'>Introduce cashless and hassle free ordering system.</span>
            <span className='text-neutrals-mid-500 text-lg tracking-[0.03em] phone:text-sm'>
        ...
        <div className='flex flex-col w-full py-16 gap-6'>
          <span className='font-secondary font-semibold text-4xl text-neutrals-dark-600'>User Persona</span>
          <span className='text-neutrals-mid-500 text-lg tracking-[0.03em] pb-8 phone:text-sm'>
          ...
          <div className='flex flex-row w-full gap-16 phone:flex-col'>
            ...
            <div className='w-[60%] phone:w-full flex flex-col gap-2'>
              <span className='font-secondary font-semibold text-4xl text-neutrals-dark-600'>Vanessa</span>
              <span className='text-neutrals-dark-600 text-lg tracking-[0.03em] pb-4'>Virtual Assistant / Freelancer</span>
              <span className='font-secondary text-xs text-neutrals-light-250 tracking-[0.07em]'>BACKGROUND</span>
              <span className='text-neutrals-mid-500 text-lg tracking-[0.03em] pb-4 phone:text-sm'>
          ...
          {/* demographics */}
          <div className='flex flex-col pt-16'>
            <span className='font-secondary text-sm text-neutrals-light-250 tracking-[0.07em]'>DEMOGRAPHICS</span>

            <hr className='border-[#24303C] mt-6'/>

            <div className='flex flex-row phone:flex-col gap-2 align-middle justify-between py-8 phone:px-10 phone:gap-6'>
              <div className='flex flex-col gap-1'>
                <span className='font-secondary text-xs text-neutrals-light-250 tracking-[0.07em]'>AGE</span>
                <span className='font-secondary font-semibold text-neutrals-dark-600 tracking-[0.03em]'>25 - 40</span>
              </div>
              <div className='flex flex-col gap-1'>
                <span className='font-secondary text-xs text-neutrals-light-250 tracking-[0.07em]'>GENDER</span>
                <span className='font-secondary font-semibold text-neutrals-dark-600 tracking-[0.03em]'>All Gender</span>
              </div>
              <div className='flex flex-col gap-1'>
                <span className='font-secondary text-xs text-neutrals-light-250 tracking-[0.07em]'>LOCATION</span>
                <span className='font-secondary font-semibold text-neutrals-dark-600 tracking-[0.03em]'>Iligan City</span>
              </div>
              <div className='flex flex-col gap-1'>
                <span className='font-secondary text-xs text-neutrals-light-250 tracking-[0.07em]'>AVERAGE MONTHLY INCOME</span>
                <span className='font-secondary font-semibold text-neutrals-dark-600 tracking-[0.03em]'>20K - 90K</span>
              </div>
              <div className='flex flex-col gap-1'>
                <span className='font-secondary text-xs text-neutrals-light-250 tracking-[0.07em]'>OCCUPATION</span>
                <ul className='font-secondary font-semibold text-neutrals-dark-600 tracking-[0.03em] list-disc phone:px-8'>
              ...
              <div className='flex flex-col gap-1 w-[15%] phone:w-full'>
                <span className='font-secondary text-xs text-neutrals-light-250 tracking-[0.07em]'>TECH SAVVINESS</span>
                <span className='font-secondary font-semibold text-neutrals-dark-600 tracking-[0.03em]'>Comfortable with digital tools, platform, and social media</span>
              </div>
            </div>
        ...
        <div className='flex flex-row gap-14 pb-8 phone:flex-col'>
          ...
          <div className=' flex flex-col w-[50%] phone:w-full gap-8'>
            <span className='font-secondary font-semibold text-4xl text-neutrals-dark-600'>CHALLENGES</span>
            <ul className='text-neutrals-mid-500 text-lg tracking-[0.03em] gap-2 pl-10 list-disc phone:pl-8 phone:text-sm'>
          ...
          {/* motivation */}
          <div className='flex flex-col w-[50%] phone:w-full gap-8'>
            <span className='font-secondary font-semibold text-4xl text-neutrals-dark-600'>MOTIVATION</span>
            <ul className='text-neutrals-mid-500 text-lg tracking-[0.03em] gap-3 list-disc pl-10 phone:pl-8 phone:text-sm'>
        ...
        <div className='flex flex-col py-16 gap-6'>
          <span className='font-secondary font-semibold text-4xl text-neutrals-dark-600'>User Flow</span>
          <span className='w-[60%] phone:w-full text-neutrals-mid-500 text-lg tracking-[0.03em] phone:text-sm'>Before proceeding to creating the high fidelity designs, the marketing interns (Barbie and Cristine) first presented the Nomo’s preliminary branding.</span>
        ...
        <div className='flex flex-col gap-12 py-16'>
          <div className='flex flex-col gap-4'>
            <span className='font-secondary font-semibold text-4xl text-neutrals-dark-600'>Style Guide</span>
            <span className='text-neutrals-mid-500 text-lg tracking-[0.03em] phone:text-sm'>Primarily, this style guide was created by John and later on collaborated with other designers inside the company in finding the right color combination for the brand. </span>
          </div>
        ...
        <div className='flex flex-col gap-12 py-16'>
          <div className='flex flex-col gap-4'>
            <span className='font-secondary font-semibold text-4xl text-neutrals-dark-600'>Early Ideation</span>
            <span className='text-neutrals-mid-500 text-lg tracking-[0.03em] phone:text-sm'>
          ...
          <div className='flex flex-col gap-4 py-16 phone:py-10'>
            <span className='text-neutrals-mid-500 text-lg tracking-[0.03em] w-[60%] phone:w-full phone:text-sm'>
        ...
        <div className='flex flex-col py-16 gap-12'>
          <div className='flex flex-col gap-4'>
            <span className='font-secondary font-semibold text-4xl text-neutrals-dark-600'>Final Designs</span>
            <span className='italic font-secondary font-semibold text-2xl text-neutrals-dark-600'>High-fidelity Designs</span>
            <span className='text-neutrals-mid-500 text-lg tracking-[0.03em] phone:text-sm'>After a few rounds of internal testing, revision and feedbacks, I have come up with the design that delivers a seamless, consistent, and user-centric design solution emphasizing how Nomo Space operates, its products and services, and how the place and the drinks offered comfort to others through the customer’s IG posts.</span>
          </div>
        ...
        <div className='flex flex-col gap-8 pt-16 pb-48 px-48 tablet:px-0 phone:px-0'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <span className='text-neutrals-mid-500 text-lg tracking-[0.03em] phone:text-sm'>I would continue the project from completing the whole initial system features and functionalities to testing the prototype until the second iteration of the designing phase. Because of the time restriction and the scope of the project, I was not able to conduct the user testing and the revisions.</span>
          </div>
