      ...
      <div className="w-screen px-24 h-auto phone:px-5 tablet:px-10">
        ...
        <div className='flex flex-col w-full py-16 gap-6'>
          ...
          <div className='flex flex-row w-full gap-16 phone:flex-col'>
            ...
            <div className='w-[60%] phone:w-full flex flex-col gap-2'>
              ...
              <span className='text-[#393939] text-lg tracking-[0.03em] pb-4'>
        ...
        <div className='flex flex-col gap-8 pt-16 pb-48 px-48 tablet:px-0 phone:px-0'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <span className='text-[#393939] text-lg tracking-[0.03em]'>I would continue the project from completing the whole initial system features and functionalities to testing the prototype until the second iteration of the designing phase. Because of the time restriction and the scope of the project, I was not able to conduct the user testing and the revisions.</span>
          </div>
